# Submission screenshot manifest

Use these clean synthetic captures in Devpost. They contain no browser chrome,
credentials, developer tools, local URLs, or personal data.

| File | Use | What it proves |
| --- | --- | --- |
| `submission/screenshots/01-owner-week-desktop.png` | Main image | Owner's compact Week in Review on desktop. |
| `submission/screenshots/02-owner-week-mobile.png` | Responsive image | The same Owner review at mobile width. |
| `submission/screenshots/03-partner-week-desktop.png` | Privacy image | Partner's separate private view with the same shared household content. |
